...
namespace Database.Migrations
{
    ...
    [Migration("20240422160650_AddingPredication")]
    partial class AddingPredication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.LabAppointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Database.Entities.MedicalTest", b =>
                {
                    ...
                    b.Property<string>("MedicalAnalystName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Database.Entities.Prediction", b =>
                {
                    ...
                    b.Property<string>("PatinetEmail")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PatinetSSN")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Database.Entities.MedicalTest", b =>
                {
                    ...
                    b.HasOne("Database.Entities.MedicalAnalyst", null)
                    ...
                    b.HasOne("Database.Entities.ApplicationUser", "Labb")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("Database.Entities.Prediction", b =>
                {
                    b.HasOne("Database.Entities.MedicalTest", "MedicalTest")
                        .WithOne("Prediction")
                        .HasForeignKey("Database.Entities.Prediction", "MedicalTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Database.Entities.ApplicationUser", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientId");
